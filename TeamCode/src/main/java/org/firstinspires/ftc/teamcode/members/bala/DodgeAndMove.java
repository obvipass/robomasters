...
public class DodgeAndMove extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        encoderDrive(DRIVE_SPEED, 72, 72, 0, 40 );
    ...
    public void encoderDrive(double speed,
                             double leftInches, double rightInches, double degrees,
                             double timeoutS) {
        ...
        if (opModeIsActive()) {
            ...
            while (opModeIsActive() &&
                ...
                telemetry.addData("Is Distance Sensor Pressed" , distanceSensor.getDistance(DistanceUnit.INCH));
                sleep(1000);


                double distanceIN = distanceSensor.getDistance((DistanceUnit.INCH));
                // double distanceIN = distanceCM / 2.54;
                telemetry.addData(" measured distance is " , distanceIN );
                telemetry.update();


                if (distanceIN <= 15.0) {

                    telemetry.addData(" under 15 inches ",  distanceIN);
                    telemetry.update();

                    sleep(1000);

                    encoderDrive(TURN_SPEED, 0, 0, 90, 40 );
                    encoderDrive(DRIVE_SPEED, 12, 12, 0, 40 );
                    encoderDrive(TURN_SPEED, 0, 0, -90, 40 );
                    encoderDrive(DRIVE_SPEED, 24, 24, 0, 40 );
                    encoderDrive(TURN_SPEED, 0, 0, -90, 40 );
                    encoderDrive(DRIVE_SPEED, 12, 12, 0, 40 );
                    encoderDrive(TURN_SPEED, 0, 0, 90, 40 );
                    encoderDrive(DRIVE_SPEED, 12, 12, 0, 40 );
