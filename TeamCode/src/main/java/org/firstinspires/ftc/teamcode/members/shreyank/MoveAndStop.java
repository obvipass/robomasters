...
@Autonomous
public class MoveAndStop extends LinearOpMode {
    ...
    private void moveForward(double distance) {
        ...
        applyEncoder2(countsToMove, countsToMove,countsToMove, countsToMove,0.1);
    }
    ...
    private void applyEncoder2(int frontLeftTarget, int frontRightTarget, int rearLeftTarget, int rearRightTarget, double power) {
        frontLeftMotor.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
        frontRightMotor.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
        backLeftMotor.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
        backRightMotor.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
