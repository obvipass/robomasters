...
public class OvershootCorrection extends LinearOpMode {
    ...
    //static final double    ERROR_PER_INCH  = 0.0206 ;
    static final double    ERROR_PER_INCH  = -0.06 ;
    ...
    public void encoderDrive(double speed,
        ...
        {
            TOTAL_ERROR = leftInches * ERROR_PER_INCH;
            newFrontLeftTarget = frontLeftDrive.getCurrentPosition() + (int)(leftInches * COUNTS_PER_INCH + TOTAL_ERROR * COUNTS_PER_INCH);
            newFrontRightTarget = frontRightDrive.getCurrentPosition() + (int)(rightInches * COUNTS_PER_INCH + TOTAL_ERROR * COUNTS_PER_INCH);
            newBackLeftTarget = backLeftDrive.getCurrentPosition() + (int)(leftInches * COUNTS_PER_INCH + TOTAL_ERROR * COUNTS_PER_INCH);
            newBackRightTarget = backRightDrive.getCurrentPosition() + (int)(rightInches * COUNTS_PER_INCH + TOTAL_ERROR * COUNTS_PER_INCH);
        }
        ...
        if (opModeIsActive()) {
            ...
            while (opModeIsActive() &&
                ...
                frontLeftDrive.setPower(Math.abs(frontLeftPower));
                frontRightDrive.setPower(Math.abs(frontRightPower));
                backLeftDrive.setPower(Math.abs(backLeftPower));
                backRightDrive.setPower(Math.abs(backRightPower));
